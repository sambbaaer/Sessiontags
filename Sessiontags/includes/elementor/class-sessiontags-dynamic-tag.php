...
class SessionTags_Dynamic_Tag extends \Elementor\Core\DynamicTags\Tag
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'default_value',
            [
                'label' => esc_html__('Individueller Fallback', 'sessiontags'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => '',
                'description' => esc_html__('Wird angezeigt, wenn der Parameter nicht in der Session existiert. Überschreibt den Standard-Fallback aus den Einstellungen.', 'sessiontags'),
            ]
        );
    }
